        ...
        <div className="space-y-4">
          <section>
            ...
            <p className="text-muted-foreground">
              ...
              Timeline → Archi → Episodi → Parti → Capitoli. Ogni elemento racconta una parte della
              storia, permettendo di esplorare diverse prospettive e linee temporali.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-1 text-muted-foreground">
              <li>
                <strong>Timeline</strong>: Container principale della storia
              </li>
              <li>
                <strong>Arc</strong>: Arco narrativo all'interno di una timeline
              </li>
              <li>
